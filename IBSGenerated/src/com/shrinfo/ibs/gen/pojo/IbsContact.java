...
public class IbsContact implements java.io.Serializable {
    ...
    private Set<IbsUser> ibsUsers = new HashSet<IbsUser>(0);
    ...
    public IbsContact(Long id, String firstName, String middleName, String lastName,
            String salutation, String title, String primaryEmailId, String primaryMobileNo,
            String primaryLandlineNo, String faxno, String city, String country, String address,
            String pobox, Integer locationLattitude, Integer locationLongitude,
            String alternateEmailId1, String alternateMobileNo1, String alternateLandlineNo1,
            String alternateEmailId2, String alternateMobileNo2, String alternateLandlineNo2,
            Byte recordType, String isStatusActive, Long recCreUserId, Date recCreDate,
            Long recUpdUserId, Date recUpdDate, Set<IbsCustomerEnquiry> ibsCustomerEnquiries,
            Set<IbsInsuranceCompany> ibsInsuranceCompanies, Set<IbsUser> ibsUsers,
            Set<IbsInsuredMaster> ibsInsuredMasters,
            Set<IbsInsuranceCompanyContact> ibsInsuranceCompanyContacts,
            Set<IbsCompany> ibsCompanies, Set<IbsCompanyBranch> ibsCompanyBranches,
            Set<IbsCustomer> ibsCustomers) {
        this.id = id;
    ...
    public Set<IbsUser> getIbsUsers() {
        return this.ibsUsers;
    }

    public void setIbsUsers(Set<IbsUser> ibsUsers) {
        this.ibsUsers = ibsUsers;
    }
